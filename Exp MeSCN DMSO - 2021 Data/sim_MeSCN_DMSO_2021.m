...
%% define initial (guess) model parameters using a structure data type
    ...
    p.('A01')				= struct('val',3.5e-5,	'var',1,	'bounds1',1e-5,	'bounds2',1e-4,	'units','arb. unit','label','A_{01}',		'SD',0, 'CI',0);
	p.('A12')				= struct('val',3.5e-5,	'var',1,	'bounds1',1e-5,	'bounds2',1e-4,	'units','arb. unit','label','A_{12}',		'SD',0, 'CI',0);
