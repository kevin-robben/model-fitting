...
%% define model parameters using a structure data type
	...
	p.('v_01')				= struct('val',2162.4,	'var',1,	'bounds1',2161,	'bounds2',2163,	'units','cm^{-1}',	'label','\omega_{01}',		'SD',0, 'CI',[0,0]);
	p.('cal_err')			= struct('val',0,		'var',1,	'bounds1',-2,	'bounds2',2,	'units','cm^{-1}',	'label','\delta\omega_1',	'SD',0, 'CI',[0,0]);
	...
	p.('kubo1_t')			= struct('val',1.7,		'var',1,	'bounds1',1e-9,	'bounds2',10,	'units','ps',		'label','\tau_1',		'SD',0, 'CI',[0,0]);
	p.('kubo1_D2')			= struct('val',6.76,	'var',1,	'bounds1',0,	'bounds2',50,	'units','cm^{-2}',	'label','\Delta_1^2',	'SD',0, 'CI',[0,0]);
%% save p
