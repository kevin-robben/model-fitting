%% Ground State Bleach
    function R = GB(p,v1_shift,v3_shift,t1,Tw,t3,r_nr)
        R = p.A01.val*exp(+1i*2*pi*0.03*(t3.*(p.v_01.val-v3_shift)+r_nr*t1.*(p.v_01.val-v1_shift+p.cal_err.val))).*exp_g_hom_01(t1,Tw,t3,p.T_LT_inv.val,p.T_hom_inv.val);
