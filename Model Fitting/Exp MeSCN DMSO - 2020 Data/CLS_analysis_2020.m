...
%% measure CLS
	for i=1:x.N2
		[CL_v3, v1_axis_2020, CLS] = trace_CL(x.v1,[2153.3-2.5,2153.3+2.5],x.v3,[2153.3-6,2153.3+6],avg_spec_3D(:,:,i),'Asymmetric Lorentzian');
		CLS_arr_01_2020(i) = CLS;
		CL_v3_arr_01_2020(i,:) = CL_v3;
		[CL_v3, v1_axis_2020, CLS] = trace_CL(x.v1,[2153.3-2.5,2153.3+2.5],x.v3,[2127.8-6,2127.8+6],-avg_spec_3D(:,:,i),'Asymmetric Lorentzian');
		CLS_arr_12_2020(i) = CLS;
		CL_v3_arr_12_2020(i,:) = CL_v3;
	end
