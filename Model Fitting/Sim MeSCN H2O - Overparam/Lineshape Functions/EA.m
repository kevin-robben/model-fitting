%% Excited State Absorption
    function R = EA(p,w1_shift,w3_shift,t1,Tw,t3,r_nr)
        R = p.A12.val*exp(+1i*2*pi*0.03*(t3.*(p.v_01.val-p.Anh.val-w3_shift)+r_nr*t1.*(p.v_01.val-w1_shift+p.cal_err.val))).*exp_g_hom_12(t1,Tw,t3,p.T_LT_inv.val,p.T_hom_inv.val);
