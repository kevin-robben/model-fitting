%% define initial (guess) model parameters using a structure data type
    ...
    p.('A01')				= struct('val',4e-05,	'var',1,	'bounds1',1e-6,	'bounds2',1e-3,	'units','arb. unit','label','A_{01}',		'SD',0, 'CI',[0,0]);
	p.('A12')				= struct('val',4e-05,	'var',1,	'bounds1',1e-6,	'bounds2',1e-3,	'units','arb. unit','label','A_{12}',		'SD',0, 'CI',[0,0]);
    p.('v_01')				= struct('val',2153.9,	'var',0,	'bounds1',2152,	'bounds2',2156,	'units','cm^{-1}',	'label','\nu_{01}',		'SD',0, 'CI',[0,0]);
    p.('cal_err')			= struct('val',-0.3,	'var',1,	'bounds1',-5,	'bounds2',5,	'units','cm^{-1}',	'label','\delta\nu_1',	'SD',0, 'CI',[0,0]);
    p.('Anh')				= struct('val',25.2,	'var',0,	'bounds1',24,	'bounds2',28,	'units','cm^{-1}',	'label','\Delta_{Anh}',	'SD',0, 'CI',[0,0]);
