...
%% linear absorption example
	...
	%% plot VIF
		...
		set(ax_1,'ytick',[1e0,1e2,1e4,1e6,1e8],'yticklabels',{'1','10^2','10^4','10^6','10^8'},'TickLength',[0.03,0])
...
%% CLS method example (linear absorbance)
	...
	%% plot VIF
		...
		set(ax_2,'ytick',[1e0,1e2,1e4,1e6,1e8],'yticklabels',{'1','10^2','10^4','10^6','10^8'},'TickLength',[0.035,0])
...
%% model fitting example
	%% plot VIF
		...
		set(ax_3,'ytick',[1e0,1e2,1e4,1e6,1e8],'yticklabels',{'1','10^2','10^4','10^6','10^8'},'TickLength',[0.02,0])
		ylim(ax_3,[1,1e9])
