...
%% define initial (guess) model parameters using a structure data type
    ...
    p.('A01')				= struct('val',20,		'var',1,	'bounds1',1e-1,	'bounds2',1e2,	'units','arb. unit','label','A_{01}',		'SD',0, 'CI',0);
	p.('A12')				= struct('val',20,		'var',1,	'bounds1',1e-1,	'bounds2',1e2,	'units','arb. unit','label','A_{12}',		'SD',0, 'CI',0);
	...
	p.('kubo1_t')			= struct('val',0.4,		'var',1,	'bounds1',0.1,	'bounds2',1,	'units','ps',		'label','\tau_1',		'SD',0, 'CI',0);
    p.('kubo1_D2')			= struct('val',15,		'var',1,	'bounds1',0,	'bounds2',50,	'units','cm^{-2}',	'label','\Delta_1^2',	'SD',0, 'CI',0);
	p.('kubo2_t')			= struct('val',5.7,		'var',1,	'bounds1',1,	'bounds2',20,	'units','ps',		'label','\tau_2',		'SD',0, 'CI',0);
    p.('kubo2_D2')			= struct('val',10,		'var',1,	'bounds1',0,	'bounds2',50,	'units','cm^{-2}',	'label','\Delta_2^2',	'SD',0, 'CI',0);
%% save p
