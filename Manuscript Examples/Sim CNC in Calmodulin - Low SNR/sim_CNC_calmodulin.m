...
%% define model parameters using a structure data type
	...
	p.('w_01')				= struct('val',2080,	'var',1,	'bounds1',2079,	'bounds2',2081,	'units','cm^{-1}',	'label','\omega_{01}',	'SD',0, 'CI',0);
	p.('cal_err')			= struct('val',0,		'var',1,	'bounds1',-1,	'bounds2',1,	'units','cm^{-1}',	'label','\delta\omega_1','SD',0, 'CI',0);
	p.('Anh')				= struct('val',25,		'var',1,	'bounds1',24,	'bounds2',26,	'units','cm^{-1}',	'label','\Delta_{Anh}',	'SD',0, 'CI',0);
