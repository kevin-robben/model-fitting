...
%% define model parameters using a structure data type
	...
	p.('w_01')				= struct('val',2162.4,	'var',1,	'bounds1',2161,	'bounds2',2163,	'units','cm^{-1}',	'label','\omega_{01}',		'SD',0, 'CI',0);
	...
	p.('kubo1_t')			= struct('val',0.4,		'var',1,	'bounds1',0.1,	'bounds2',10,	'units','ps',		'label','\tau_1',		'SD',0, 'CI',0);
	p.('kubo1_D2')			= struct('val',33.64,	'var',1,	'bounds1',0,	'bounds2',50,	'units','cm^{-2}',	'label','\Delta_1^2',	'SD',0, 'CI',0);
	p.('kubo2_t')			= struct('val',1.7,		'var',1,	'bounds1',0.1,	'bounds2',10,	'units','ps',		'label','\tau_2',		'SD',0, 'CI',0);
	p.('kubo2_D2')			= struct('val',6.76,	'var',1,	'bounds1',0,	'bounds2',50,	'units','cm^{-2}',	'label','\Delta_2^2',	'SD',0, 'CI',0);
%% save p
